...
$.fn.tablepager = function() {
    function the_pager() {
        ...
        function set_page(newpage) {
            ...
            $pager.find('.tablepager-display').val(page + " van " + numpages);
            set_visibility();
        }
        ...
        function create_pager() {
            var pagerhtml = 
                ...
                '<img class="tablepager-first" src="images/icons/firstpage.png" style="width: 30px; vertical-align: middle;"/>'+
                '<img class="tablepager-prev" src="images/icons/prevpage.png" style="width: 20px; vertical-align: middle;"/>'+
                // '<button type="button" class="tablepager-prev"></button>'+
                '<input type="text" class="tablepager-display" readonly>'+
                '<img class="tablepager-next" src="images/icons/nextpage.png" style="width: 20px; vertical-align: middle;"/>'+
                '<img class="tablepager-last" src="images/icons/lastpage.png" style="width: 30px; vertical-align: middle;"/>'+
